...
namespace ntokenize::lex {
  map<int16_t,string> token_name = {
    ...
    TokenEntry(Number),
    TokenEntry(BinNumber),
    TokenEntry(OctNumber),
    TokenEntry(DecNumber),
    TokenEntry(HexNumber),
    TokenEntry(FloatNumber),
    TokenEntry(ImagNumber),

    TokenEntry(String),
    TokenEntry(SingleString),
    TokenEntry(DoubleString),
    TokenEntry(Single3String),
    TokenEntry(Double3String),
    TokenEntry(TripleString),
